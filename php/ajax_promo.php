<?php
    ...
    $sql = 'select nome, prezzo, desc_breve, imm from dispositivo as d join immagine as i on d.cod_disp = i.cod_prop where promo ="'.$var.'" && tipo = "prim"';
